//Марија Ристевска ИНКИ 819. Задача број 5 за транспортно претпријатие во која креирана е променлива N во која е додадена вредност 10, потоа се креирани две листи со по 10 рандом елементи. Направен е for циклус кој брои n пати и прави пресметки, и на крај се печатат вредностите од пресметките
#include <cstdlib>
#include <iostream>
